...
let greeting = liveTime >= 5 && liveTime < 12 ? "Have a Good Morning!" : 
liveTime >= 12 && liveTime < 18 ? "Have a Good Afternoon!" :
liveTime >= 18 && liveTime < 21 ? "Have a Good Evening!" : "Have a Good Night!";
...
function liveClock(){
    ...
    var showDay = liveDate.getDay(),
        ...
        var idNames = ["day", "month", "date", "year", "hour", "minutes", "period"];
        
        var valueNames = [week[showDay], months[showMonth], showDate.pad(2), showYear, showHours.pad(2), showMinutes.pad(2), showPeriod];
